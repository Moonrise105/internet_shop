...
class CartProduct(models.Model):
    ...
    final_price = models.DecimalField(max_digits=15, decimal_places=3, verbose_name='Сумма')
...
class Cart(models.Model):
    ...
    final_price = models.DecimalField(max_digits=15, default=0, decimal_places=3, verbose_name='Сумма')
